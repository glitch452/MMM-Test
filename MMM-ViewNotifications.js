...
(function (exports, moment, Log) {
    ...
    ***************************************************************************** */
    ...
    var MmmLogger = (function () {
        ...
        Object.defineProperty(MmmLogger.prototype, "level", {
            get: function () {
                return this._level;
            },
            enumerable: false,
        ...
        Object.defineProperty(MmmLogger.prototype, "properties", {
            get: function () {
        ...
        MmmLogger.prototype.processMessage = function (message) {
            if (this._level === 3) {
                ...
                return "".concat(this._properties.name, ": (").concat(this._properties.data.index, ")(").concat(time, ") ").concat(message);
            }
            return "".concat(this._properties.name, ": ").concat(message);
        };
